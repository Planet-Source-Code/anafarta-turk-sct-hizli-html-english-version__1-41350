...
Begin VB.Form frmliste 
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Select the List things Numbers"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   162
...
Dim x As Long, y
    ...
    frmAna.textHTML.SelRTF = "<UL>" + vbCrLf
        Do
            x = txtlist.Text
            frmAna.textHTML.SelRTF = "<LI> ÷elerinizi burada listeleyin </LI>"
            y = y + 1
        Loop While y < x
    frmAna.textHTML.SelRTF = "</UL>" + vbCrLf
    End If
    ' ALFABET›K SIRAYLA HARF L›STES›
